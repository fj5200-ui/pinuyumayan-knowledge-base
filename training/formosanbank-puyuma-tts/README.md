...
> Vendored from `https://github.com/fj5200-ui/pinuyumayan-knowledger` and integrated into this repository for private TTS gap-fill work.
...
目前主 repo 已生成私有補音 manifest：

- `../../data/audio/puyuma_tts_gap_manifest_v65.jsonl`

若你已經有可用的 Coqui TTS checkpoint，可執行：

```powershell
python -m formosanbank_puyuma.synthesize_gaps `
  --manifest ..\..\data\audio\puyuma_tts_gap_manifest_v65.jsonl `
  --output-dir runs\gap_fill `
...
- 私有 gap fill 產出的 synthetic audio 不能標記成已驗證真人來源音檔；仍需族語審核。
