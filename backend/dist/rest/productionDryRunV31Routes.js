...
function accepted(req, res, kind) {
...
export function registerProductionDryRunV31Routes(app) {
    ...
    app.get("/api/ops/dry-run/v31/readiness", (_req, res) => {
        const checklist = readJson("data/deployment/production_dry_run_checklist_v31.json", { phases: [] });
