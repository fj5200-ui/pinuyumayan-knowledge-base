...
import { getBootstrapData, getCommunityProfile, getDeltaSince, getKnowledgeBundle, getRelatedKnowledge, listVocabularyAudio, searchPublicKnowledge } from "../modules/mainSiteKnowledge/service";
function asyncRoute(handler) {
    return (req, res, next) => {
        handler(req, res).catch(next);
    };
}
export function registerMainSiteKnowledgeRoutes(app, createContextFn) {
